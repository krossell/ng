module.exports = function (app) {
	...
	app.service('phx.workQ.components.conditionBuilder.schemas.whereSchema', Service);

	Service.$inject = ['$q', 'phx.workQ.components.conditionBuilder.validation.validatorFactory'];

	var ops = require('./operations'),
		 operations = ops.typeMapping;

	function Service($q, validatorFactory) {
		return function (conditionBuilder, context) {

			var suggestT = require('./suggest')($q, context)('#field'),
			...
			var validator = validatorFactory(context);
